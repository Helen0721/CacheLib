...
template <>
struct VisitByFieldId<::facebook::cachelib::serialization::SieveListObject> {
  template <typename F, typename T>
  void operator()([[maybe_unused]] F&& f, int32_t fieldId, [[maybe_unused]] T&& t) const {
    switch (fieldId) {
    case 1:
    ...
    case 2:
      return f(1, static_cast<T&&>(t).compressedTail_ref());
    case 3:
      return f(2, static_cast<T&&>(t).compressedHand_ref());
    case 4:
      return f(3, static_cast<T&&>(t).size_ref());
    default:
      throwInvalidThriftId(fieldId, "::facebook::cachelib::serialization::SieveListObject");
    }
  }
};
} // namespace detail
