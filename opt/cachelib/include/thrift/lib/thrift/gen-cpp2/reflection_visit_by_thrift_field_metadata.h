...
template <>
struct VisitByFieldId<::apache::thrift::reflection::StructField> {
  ...
  void operator()([[maybe_unused]] F&& f, int32_t fieldId, [[maybe_unused]] T&& t) const {
    ...
    default:
      throwInvalidThriftId(fieldId, "::apache::thrift::reflection::StructField");
    }
  }
};

template <>
struct VisitByFieldId<::apache::thrift::reflection::DataType> {
  template <typename F, typename T>
  void operator()([[maybe_unused]] F&& f, int32_t fieldId, [[maybe_unused]] T&& t) const {
    switch (fieldId) {
    case 1:
    ...
    default:
      throwInvalidThriftId(fieldId, "::apache::thrift::reflection::DataType");
    }
  }
};

template <>
struct VisitByFieldId<::apache::thrift::reflection::Schema> {
  template <typename F, typename T>
  void operator()([[maybe_unused]] F&& f, int32_t fieldId, [[maybe_unused]] T&& t) const {
    switch (fieldId) {
    case 1:
    ...
    default:
      throwInvalidThriftId(fieldId, "::apache::thrift::reflection::Schema");
    }
  }
};
} // namespace detail
