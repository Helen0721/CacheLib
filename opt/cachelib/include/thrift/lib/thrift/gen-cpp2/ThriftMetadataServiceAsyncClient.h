...
class Client<::apache::thrift::metadata::ThriftMetadataService> : public apache::thrift::GeneratedAsyncClient {
 public:
  ...
  /** Glean {"file": "/mnt/cfs/CacheLib/cachelib/external/fbthrift/thrift/lib/thrift/metadata.thrift", "service": "ThriftMetadataService", "function": "getThriftServiceMetadata"} */
