...
template <>
struct ForEachField<::apache::thrift::FdMetadata> {
  template <typename F, typename... T>
  void operator()([[maybe_unused]] F&& f, [[maybe_unused]] T&&... t) const {
    f(0, static_cast<T&&>(t).fdSeqNum_ref()...);
    f(1, static_cast<T&&>(t).numFds_ref()...);
  }
};

template <>
struct ForEachField<::apache::thrift::LoggingContext> {
  template <typename F, typename... T>
  void operator()([[maybe_unused]] F&& f, [[maybe_unused]] T&&... t) const {
    f(0, static_cast<T&&>(t).logSampleRatio_ref()...);
    f(1, static_cast<T&&>(t).logErrorSampleRatio_ref()...);
    f(2, static_cast<T&&>(t).requestId_ref()...);
    f(3, static_cast<T&&>(t).routingTarget_ref()...);
    f(4, static_cast<T&&>(t).requestAttemptId_ref()...);
  }
};
...
struct ForEachField<::apache::thrift::RequestRpcMetadata> {
  ...
  void operator()([[maybe_unused]] F&& f, [[maybe_unused]] T&&... t) const {
    ...
    f(3, static_cast<T&&>(t).clientTimeoutMs_ref()...);
    f(4, static_cast<T&&>(t).queueTimeoutMs_ref()...);
    f(5, static_cast<T&&>(t).priority_ref()...);
    f(6, static_cast<T&&>(t).otherMetadata_ref()...);
    f(7, static_cast<T&&>(t).crc32c_ref()...);
    f(8, static_cast<T&&>(t).loadMetric_ref()...);
    f(9, static_cast<T&&>(t).compression_ref()...);
    f(10, static_cast<T&&>(t).compressionConfig_ref()...);
    f(11, static_cast<T&&>(t).interactionId_ref()...);
    f(12, static_cast<T&&>(t).interactionCreate_ref()...);
    f(13, static_cast<T&&>(t).clientId_ref()...);
    f(14, static_cast<T&&>(t).serviceTraceMeta_ref()...);
    f(15, static_cast<T&&>(t).frameworkMetadata_ref()...);
    f(16, static_cast<T&&>(t).fdMetadata_ref()...);
    f(17, static_cast<T&&>(t).loggingContext_ref()...);
    f(18, static_cast<T&&>(t).tenantId_ref()...);
  }
};
...
template <>
struct ForEachField<::apache::thrift::PayloadAnyExceptionMetadata> {
  template <typename F, typename... T>
  void operator()([[maybe_unused]] F&& f, [[maybe_unused]] T&&... t) const {
  }
};
...
struct ForEachField<::apache::thrift::PayloadExceptionMetadata> {
  ...
  void operator()([[maybe_unused]] F&& f, [[maybe_unused]] T&&... t) const {
    ...
    f(1, static_cast<T&&>(t).DEPRECATED_proxyException_ref()...);
    f(2, static_cast<T&&>(t).appUnknownException_ref()...);
    f(3, static_cast<T&&>(t).anyException_ref()...);
  }
};
...
template <>
struct ForEachField<::apache::thrift::QueueMetadata> {
  template <typename F, typename... T>
  void operator()([[maybe_unused]] F&& f, [[maybe_unused]] T&&... t) const {
    f(0, static_cast<T&&>(t).queueingTimeMs_ref()...);
    f(1, static_cast<T&&>(t).queueTimeoutMs_ref()...);
  }
};
...
struct ForEachField<::apache::thrift::ResponseRpcMetadata> {
  ...
  void operator()([[maybe_unused]] F&& f, [[maybe_unused]] T&&... t) const {
    ...
    f(1, static_cast<T&&>(t).load_ref()...);
    f(2, static_cast<T&&>(t).crc32c_ref()...);
    f(3, static_cast<T&&>(t).compression_ref()...);
    f(4, static_cast<T&&>(t).payloadMetadata_ref()...);
    f(5, static_cast<T&&>(t).proxiedPayloadMetadata_ref()...);
    f(6, static_cast<T&&>(t).streamId_ref()...);
    f(7, static_cast<T&&>(t).queueMetadata_ref()...);
    f(8, static_cast<T&&>(t).fdMetadata_ref()...);
    f(9, static_cast<T&&>(t).frameworkMetadata_ref()...);
  }
};
...
struct ForEachField<::apache::thrift::StreamPayloadMetadata> {
  ...
  void operator()([[maybe_unused]] F&& f, [[maybe_unused]] T&&... t) const {
    ...
    f(3, static_cast<T&&>(t).fdMetadata_ref()...);
  }
};
...
struct ForEachField<::apache::thrift::RequestSetupMetadata> {
  ...
  void operator()([[maybe_unused]] F&& f, [[maybe_unused]] T&&... t) const {
    ...
    f(6, static_cast<T&&>(t).qosUseCaseId_ref()...);
    f(7, static_cast<T&&>(t).qosPolicyId_ref()...);
    f(8, static_cast<T&&>(t).clientMetadata_ref()...);
    f(9, static_cast<T&&>(t).keepAliveTimeoutMs_ref()...);
  }
};
...
struct ForEachField<::apache::thrift::SetupResponse> {
  ...
  void operator()([[maybe_unused]] F&& f, [[maybe_unused]] T&&... t) const {
    ...
    f(1, static_cast<T&&>(t).zstdSupported_ref()...);
  }
};
...
template <>
struct ForEachField<::apache::thrift::TransportMetadataPush> {
  template <typename F, typename... T>
  void operator()([[maybe_unused]] F&& f, [[maybe_unused]] T&&... t) const {
    f(0, static_cast<T&&>(t).transportMetadata_ref()...);
  }
};
...
struct ForEachField<::apache::thrift::ClientPushMetadata> {
  ...
  void operator()([[maybe_unused]] F&& f, [[maybe_unused]] T&&... t) const {
    ...
    f(1, static_cast<T&&>(t).streamHeadersPush_ref()...);
    f(2, static_cast<T&&>(t).transportMetadataPush_ref()...);
  }
};
